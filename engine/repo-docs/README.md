# Метадокументация репозитория

Файлы в этой папке — **не** пользовательская документация MedControl на сайте; это заметки про устройство репо и работу с Cursor.

| Файл | Назначение |
|------|------------|
| [**`brief.md`**](brief.md) | Краткий бриф платформы (цели, границы) |
