...
**Расположение:** корень репозитория, папка `references/` (референсы проекта; не путать с `docs-app/public/content/references/` — там PDF и материалы контента внутри приложения).
